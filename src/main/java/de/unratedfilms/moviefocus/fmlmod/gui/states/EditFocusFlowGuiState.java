...
import de.unratedfilms.moviefocus.fmlmod.flow.FocusFlow;
...
public class EditFocusFlowGuiState extends GuiState {
    ...
    private static class Screen extends BasicScreen {
        ...
        private WidgetFlexible createWidgetFromFlowEntry(FocusFlowEntry flowEntry) {
            ...
            ButtonLabel editButton = new ButtonLabelImpl(I18n.format("gui." + MOD_ID + ".editFocusFlow.editEntry"), (b, m) -> {});
            editButton.setHandler(new FilteredButtonHandler(MouseButton.LEFT, (b, mb) -> GuiStateMachine.transitionToState(new EditFocusFlowEntryGuiState(flowEntry))));
